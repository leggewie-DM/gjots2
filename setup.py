...
setup(name = "gjots2",
	  ...
	  data_files = [('lib/gjots2',['lib/__init__.py', 'lib/file.py', 'lib/general.py', 'lib/prefs.py', 'lib/common.py', 'lib/find.py', 'lib/gui.py', 'lib/prefs.py', 'lib/version.py', 'lib/printDialog.py', 'lib/sortDialog.py']),
					...
					('share/doc/gjots2', ['gjots2.gjots','AUTHORS','README','INSTALL', 'COPYING', 'ChangeLog']),
					('share/doc/gjots2', ['gjots2.en_US.gjots']),
					('share/doc/gjots2', ['gjots2.fr.gjots']),
					('share/doc/gjots2', ['gjots2.no.gjots']),
					('share/doc/gjots2', ['gjots2.nb.gjots']),
					('share/doc/gjots2', ['gjots2.ru.gjots']),
